<script setup>
  ...
  function submitForm(){
    ...
    axios.post('http://localhost:8080/consultoring/cliente', formInfo);
    alert("Datos enviados correctamente, en breve nos pondremos en contacto con usted.");
    ...
    <article>
      ...
      <form @submit.prevent="submitForm" id="form" class="flex justify-evenly bg-gray-800">
        ...
        >
              ...
              <div class="sm:col-span-4">
                ...
                <div class="mt-2">
                  <input
                    ...
                    type="email"
                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:ml-6 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
          ...
          <div class="mt-6 flex items-center self-center gap-x-6">
                <button
                  type="submit"
                  class="rounded-md self-center bg-cyan-500 font-bold px-6 py-3 text-sm text-white shadow-sm hover:bg-cyan-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Enviar formulario
                </button>
              </div>
...
#container {
  ...
  border-radius: 0px;
  background: #1f2937;
  box-shadow:  10px 10px 20px #141a23,
             -10px -10px 20px #2a384b;
